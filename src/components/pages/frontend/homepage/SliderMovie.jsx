    ...
    <>
       <section className="slider-parent bg-dark -mt-5 relative px-4">
        ...
        <button
          ...
          className="slide-nav-btn absolute top-[17.8%] z-[1] h-[180px] w-[60px] bg-black bg-opacity-60 opacity-0 transition-opacity hover:opacity-100"
        >
        ...
        <button
          ...
          className="slide-nav-btn absolute top-[17.8%] right-4 z-[1] h-[180px] w-[60px] bg-black bg-opacity-60 opacity-0 transition-opacity hover:opacity-100"
        >
